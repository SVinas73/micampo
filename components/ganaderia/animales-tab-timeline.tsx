              ...
              <React.Fragment key={i}>
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 40, flexShrink: 0, position: "relative" }}>
                    ...
                    <div style={{ width: 34, height: 34, borderRadius: "50%", flexShrink: 0, background: `linear-gradient(135deg, ${cat.color}22, ${cat.color}11)`, border: `2px solid ${cat.color}50`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, marginTop: 2, boxShadow: isHov ? `0 0 0 4px ${cat.color}18, 0 2px 8px ${cat.color}28` : `0 0 0 3px ${cat.color}12`, transition: "box-shadow 0.2s, transform 0.15s", transform: isHov ? "scale(1.12)" : "scale(1)" }}>{cat.icon}</div>
                  </div>
