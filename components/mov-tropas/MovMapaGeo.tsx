    ...
    movs.forEach((m) => {
      ...
      if (a && b && a.nombre !== b.nombre) {
        ...
        L.marker(mid, {
          icon: L.divIcon({
            className: "",
            html: `<div style="transform:rotate(${-ang}deg);display:flex;line-height:0"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></div>`,
