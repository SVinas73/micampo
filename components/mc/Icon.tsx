...
export const ICONS = {
  ...
  pdf: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M8.5 13.5h1a1.2 1.2 0 0 1 0 2.4h-1V18"/><path d="M15.5 13.5h-2V18"/><path d="M13.9 15.8h1.4"/></>,
  ...
  // --- Ganadería (referencia MiCampo) ---
  "alert-circle": <><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></>,
  "alert-triangle": <><path d="M10.3 3.8L2.6 18a2 2 0 0 0 1.7 3h15.4a2 2 0 0 0 1.7-3L13.7 3.8a2 2 0 0 0-3.4 0z"/><path d="M12 9v4M12 17h.01"/></>,
  "arrow-right": <><path d="M5 12h14M12 5l7 7-7 7"/></>,
  beef: <><path d="M17.5 6.5a4.5 4.5 0 1 0-8.62 1.78 4.5 4.5 0 1 0-4.78 6.5A4.5 4.5 0 1 0 12.5 19a4.5 4.5 0 1 0 8.62-1.78 4.5 4.5 0 1 0-3.62-10.72z"/><circle cx="12" cy="12" r="2.5"/></>,
  brain: <><path d="M9.5 2a2.5 2.5 0 0 0-2.5 2.5v.5a3 3 0 0 0-2 2.83V9a3 3 0 0 0 0 6v1.17A3 3 0 0 0 7 19v.5A2.5 2.5 0 0 0 9.5 22"/><path d="M14.5 2a2.5 2.5 0 0 1 2.5 2.5v.5a3 3 0 0 1 2 2.83V9a3 3 0 0 1 0 6v1.17A3 3 0 0 1 17 19v.5a2.5 2.5 0 0 1-2.5 2.5"/><path d="M9.5 2v20M14.5 2v20"/></>,
  "check-circle": <><path d="M22 11.1V12a10 10 0 1 1-5.9-9.1"/><path d="M22 4L12 14.1l-3-3"/></>,
  "chevron-down": <path d="M6 9l6 6 6-6"/>,
  "chevron-left": <path d="M15 18l-6-6 6-6"/>,
  "chevron-right": <path d="M9 6l6 6-6 6"/>,
  droplets: <><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3C6.71 6.75 5.85 7.32 4.71 8.21 3.57 9.1 3 10.19 3 11.35 3 13.57 4.8 15.4 7 16.3z"/><path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97"/></>,
  ...
  hand: <><path d="M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v5"/><path d="M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v6"/><path d="M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8"/><path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-1-6-3l-3.3-4.3a2 2 0 1 1 3-2.6L8 14"/></>,
  info: <><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></>,
  "map-pin": <><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></>,
  mapPin: <><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></>,
  microscope: <><path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14v4"/><path d="M9 2v3"/><path d="M9 5h5v5H9z"/></>,
  "move-right": <path d="M14 8l6 4-6 4M4 12h16"/>,
